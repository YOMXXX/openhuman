...
const zhCN5: TranslationMap = {
  ...
  'settings.developerMenu.actionBudget.title': '行动预算',
  'settings.developerMenu.actionBudget.desc': '设置工具行动的本地每小时上限',
  ...
  'settings.actionBudget.title': '行动预算',
  'settings.actionBudget.activeLimit': '当前上限',
  'settings.actionBudget.sideEffectingActions': '会产生副作用的工具行动',
  'settings.actionBudget.actionsPerHour': 'actions/hour',
  'settings.actionBudget.actionsPerHourLabel': '每小时行动数',
  'settings.actionBudget.desktopOnly': '行动预算仅在桌面应用中可用。',
  'settings.actionBudget.loadFailed': '无法加载行动预算。',
  'settings.actionBudget.saveFailed': '无法保存行动预算。',
  'settings.actionBudget.validation': '请输入 1 到 1000 的整数。',
  'settings.actionBudget.saved': '已保存',
  'settings.actionBudget.saving': '保存中...',
